...
Public Class selling_area
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JewelleryStore.selling_area.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedselling_area
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As selling_area = New selling_area()
        rpt.Site = Me.Site
        Return rpt
    End Function
