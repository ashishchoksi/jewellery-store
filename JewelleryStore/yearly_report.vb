...
Public Class yearly_report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JewelleryStore.yearly_report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedyearly_report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As yearly_report = New yearly_report()
        rpt.Site = Me.Site
        Return rpt
    End Function
