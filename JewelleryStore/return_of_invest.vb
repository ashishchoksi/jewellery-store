...
Public Class return_of_invest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JewelleryStore.return_of_invest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreturn_of_invest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As return_of_invest = New return_of_invest()
        rpt.Site = Me.Site
        Return rpt
    End Function
