...
Public Class product_wise_sales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JewelleryStore.product_wise_sales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedproduct_wise_sales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As product_wise_sales = New product_wise_sales()
        rpt.Site = Me.Site
        Return rpt
    End Function
